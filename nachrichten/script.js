...
async function loadNews() {
    const url = "https://script.google.com/macros/s/AKfycbxQnVhEKok0dzophckOLB8ij4yiVUx-BVxh7Z3JB_EpXiXrFLNlzFEbr9gLStpYimNBrw/exec"; // Заменить на реальный URL
    try {
        let response = await fetch(url);
...
function updatePaginationButtons() {
    ...
    document.getElementById("nextPage").disabled = currentPage * pageSize >= newsData.length;
}
